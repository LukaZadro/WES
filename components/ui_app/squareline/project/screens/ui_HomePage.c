...
void ui_HomePage_screen_init(void)
{
    ...
    ui_ImageBg1 = lv_img_create(ui_HomePage);
    lv_img_set_src(ui_ImageBg1, &ui_img_wp2844947_png);
    ...
    lv_obj_add_flag(ui_ImageBg1, LV_OBJ_FLAG_HIDDEN | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_ImageBg1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
